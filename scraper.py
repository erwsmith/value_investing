...
# CIK numbers can be found here: https://www.sec.gov/edgar/scearchedgar/companysearch.html
# 
company_CIKs = ['707549']
filing_types = ['10-k']
...
db_name = 'edgar.db'
# Specify the folder path for DB file.
...
# Handle connection(s) to SQLite database(s).
class DB_Connection:
                ...
                for Filing_Type in self.filing_types:
                    ...
                    for row in main_table[0].find_all('tr'):
                        ...
                        if len(cols) != 0:
                            ...
                            print(Filing_Type, Filing_Date, Filing_Number)
